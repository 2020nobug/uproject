...
const state = {
  ...
  exam: {
    examPaper: {
      paperTypeEnum: [{ key: 1, value: 'Fiexed Paper' }, { key: 4, value: 'Time Period Paper' }]
    },
    examPaperAnswer: {
    ...
    question: {
      typeEnum: [{ key: 1, value: 'Single choice' }, { key: 2, value: 'Multiple Choice' }, { key: 3, value: 'Judgment' }, { key: 4, value: 'Fill in the blanks' }, { key: 5, value: 'Short answer question' }],
      answer: {
        doRightTag: [{ key: true, value: 'success' }, { key: false, value: 'danger' }, { key: null, value: 'warning' }],
        doRightEnum: [{ key: true, value: 'right' }, { key: false, value: 'wrong' }, { key: null, value: '待批改' }],
