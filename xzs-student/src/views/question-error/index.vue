    ...
    <el-row :gutter="50">
      <el-col :span="14">
        <el-table v-loading="listLoading" :data="tableData" fit highlight-current-row style="width: 100%" @row-click="itemSelect">
          ...
          <el-table-column prop="questionType" label="Type"  :formatter="questionTypeFormatter" width="120px" />
          <el-table-column prop="subjectName" label="Subject"  width="150" />
          <el-table-column prop="createTime" label="Time Spent"  width="170" />
        </el-table>
