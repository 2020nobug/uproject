<template>
  <div style="margin-top: 10px">
    ...
    <el-row class="app-item-contain">
      <h3 class="index-title-h3" style="border-left: solid 10px #3651d4;">Task Center</h3>
    ...
    <el-row class="app-item-contain">
      <h3 class="index-title-h3">Fixed paper</h3>
      <div style="padding-left: 15px">
            ...
            <div style="padding: 14px;">
              ...
              <div class="bottom clearfix">
                <router-link target="_blank" :to="{path:'/do',query:{id:item.id}}">
                  <el-button type="text" class="button" style="font-size: 20px">Start</el-button>
                </router-link>
              </div>
            </div>
          </el-card>
    ...
    <el-row class="app-item-contain">
      <h3 class="index-title-h3" style="border-left: solid 10px rgb(220, 208, 65);">Time Period Paper</h3>
      <div style="padding-left: 15px">
...
export default {
  ...
  // 通过key 获取试题状态 文本和标签的value, 这里调用enumItem.js里面的enumFormat方法
  methods: {
  ...
  computed: {
    // 去enumItem.js 里面找enumFormat getter方法，方便调用
    ...mapGetters('enumItem', [
      'enumFormat'
    ]),
    ...mapState('enumItem', {
