     ...
     <el-row :gutter="50">
       <el-col :span="18">
         <el-table v-loading="listLoading" :data="tableData" fit highlight-current-row style="width: 100%" @row-click="itemSelect">
           ...
           <el-table-column prop="subjectName" label="Subject"  width="150px" />
           ...
           <el-table-column prop="createTime" label="Test Date"  width="170" />
           <el-table-column  align="right" width="70">
             <template slot-scope="{row}">
               ...
               <router-link target="_blank" :to="{path:'/read',query:{id:row.id}}" v-if="row.status === 2 ">
                 <el-button  type="text" size="small"><span style="font-size: 15px">Check</span></el-button>
               </router-link>
             </template>
           </el-table-column>
         </el-table>
       ...
       <el-col  :span="6" >
         <el-card  class="record-answer-info" >
            <el-form label-width="60%"  id="form1" >
              ...
              <el-form-item label="Right question number：">
